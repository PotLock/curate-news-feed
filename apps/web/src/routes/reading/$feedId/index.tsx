...
function ReadingLayoutPage() {
  ...
  const [currentArticleIndex, setCurrentArticleIndex] = useState(search.article || 0);
  ...
  const getNavigationItems = () => {
    ...
    const prevItem = currentArticleIndex > 0 ? feedItems[currentArticleIndex - 1] : null;
    const nextItem = 
      currentArticleIndex < feedItems.length - 1 ? feedItems[currentArticleIndex + 1] : null;
