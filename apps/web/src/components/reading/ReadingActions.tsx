  ...
  return (
    <div className="flex flex-row lg:flex-col gap-3 lg:gap-4 justify-center lg:justify-start">
      ...
      >
        ...
        >
          <path
            d="M16.9265 10.5394L17.3579 8.92948C17.8614 7.05024 18.1132 6.11063 17.9236 5.29748C17.7739 4.65543 17.4371 4.07219 16.956 3.62152C16.3466 3.05075 15.4069 2.79898 13.5277 2.29544C11.6485 1.7919 10.7089 1.54013 9.89572 1.72973C9.25367 1.87944 8.67043 2.21617 8.21976 2.69735C7.73107 3.21911 7.47623 3.98294 7.097 5.3713C7.03331 5.60449 6.96611 5.8553 6.89369 6.12554L6.89368 6.1256L6.46231 7.73548C5.95877 9.61471 5.707 10.5543 5.8966 11.3675C6.04631 12.0095 6.38304 12.5928 6.86422 13.0434C7.47362 13.6142 8.41324 13.866 10.2925 14.3695L10.2925 14.3695C11.9863 14.8234 12.9168 15.0727 13.6793 14.9786C13.7628 14.9683 13.8442 14.9539 13.9245 14.9352C14.5665 14.7855 15.1498 14.4488 15.6004 13.9676C16.1712 13.3582 16.423 12.4186 16.9265 10.5394Z"
            stroke="#1C274C"
            strokeWidth="1.5"
          />
          <path
            d="M13.679 14.9784C13.5053 15.5105 13.1997 15.9918 12.789 16.3766C12.1796 16.9473 11.24 17.1991 9.36072 17.7026C7.48149 18.2062 6.54187 18.4579 5.72872 18.2683C5.08668 18.1186 4.50344 17.7819 4.05276 17.3007C3.48199 16.6913 3.23023 15.7517 2.72669 13.8725L2.29532 12.2626C1.79178 10.3834 1.54001 9.44375 1.72961 8.6306C1.87932 7.98856 2.21605 7.40532 2.69723 6.95464C3.30663 6.38387 4.24625 6.13211 6.12548 5.62857C6.48101 5.5333 6.80291 5.44705 7.09668 5.37109"
            stroke="#1C274C"
            strokeWidth="1.5"
          />
          <path
            d="M9.81396 8.33337L13.8387 9.41179"
            stroke="#1C274C"
            strokeWidth="1.5"
            strokeLinecap="round"
          />
          <path
            d="M9.1665 10.748L11.5813 11.3951"
            stroke="#1C274C"
            strokeWidth="1.5"
            strokeLinecap="round"
          />
